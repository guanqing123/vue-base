...
console.log(__WEBPACK_IMPORTED_MODULE_1__App_js__["c" /* num1 */]);
console.log(__WEBPACK_IMPORTED_MODULE_1__App_js__["d" /* num2 */]);
console.log(__WEBPACK_IMPORTED_MODULE_1__App_js__["a" /* add */](3, 5));

new __WEBPACK_IMPORTED_MODULE_0__Vue_js___default.a({
    el:'#app',
    components:{
        App:__WEBPACK_IMPORTED_MODULE_1__App_js__["b" /* default */]
    },
    template:`
        <App />
    `
